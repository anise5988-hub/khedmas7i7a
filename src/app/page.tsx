...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f8fafc] text-[#11233f] dark:bg-[#0c1626] dark:text-white">
      ...
      <section className="border-b border-slate-200 bg-gradient-to-b from-white to-slate-50 text-[#11233f] dark:border-white/10 dark:bg-[#0f1d32] dark:text-white">
        {statsError && (
          <div className="mx-auto max-w-7xl px-5 pt-4 sm:px-8 lg:px-10">
            <div className="flex items-center gap-2 rounded-xl border border-amber-400/30 bg-amber-400/10 px-4 py-2.5 text-xs font-semibold text-amber-600 dark:text-amber-300">
        ...
        {stats === null && !statsError ? (
          <div className="mx-auto grid max-w-7xl grid-cols-2 gap-5 px-5 py-9 sm:grid-cols-3 lg:grid-cols-5 lg:px-10">
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="flex items-center gap-3">
                <div className="h-12 w-12 shrink-0 animate-pulse rounded-2xl bg-slate-200 dark:bg-white/10" />
                <div className="flex-1 space-y-2">
                  <div className="h-5 w-16 animate-pulse rounded bg-slate-200 dark:bg-white/10" />
                  <div className="h-3 w-20 animate-pulse rounded bg-slate-100 dark:bg-white/5" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mx-auto grid max-w-7xl grid-cols-2 gap-5 px-5 py-9 sm:grid-cols-3 lg:grid-cols-5 lg:px-10">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#e5f7f2] text-[#0d8d78] dark:bg-[#72d6bf]/15 dark:text-[#72d6bf] dark:border dark:border-[#72d6bf]/20">
                <IconUser className="h-6 w-6" />
              </div>
              <div>
                <p className="text-2xl font-bold text-[#11233f] dark:text-white">
                  {stats ? formatStat(stats.studentsCount) : "0"}
                </p>
                <p className="text-xs text-slate-500 dark:text-slate-400">Élèves inscrits</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Professeurs certifiés</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Heures de cours</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-[#11233f] dark:text-white">{courses.length}</p>
                <p className="text-xs text-slate-500 dark:text-slate-400">Cours &amp; packs</p>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#fff7e6] text-amber-500 dark:bg-amber-400/15 dark:text-amber-300 dark:border dark:border-amber-400/20">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Taux de satisfaction</p>
              </div>
            </div>
          </div>
        )}
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
          <div>
            <span className="inline-flex items-center gap-1.5 rounded-full bg-[#e5f7f2] text-[#0d8d78] dark:bg-[#72d6bf]/15 dark:border dark:border-[#72d6bf]/30 px-3.5 py-1 text-xs font-extrabold uppercase tracking-wider dark:text-[#72d6bf]">
            ...
            <p className="mt-2 text-xs sm:text-sm text-slate-500 dark:text-slate-300 max-w-xl">
          ...
          <Link
            href="/levels"
            className="text-xs font-bold text-[#0d8d78] hover:text-[#0b7866] dark:text-[#72d6bf] dark:hover:text-[#5ec4ad] hover:underline shrink-0"
          >
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <div className="mt-6 flex items-center justify-between text-xs font-bold text-[#0d8d78] dark:text-[#72d6bf]">
      ...
      <section id="courses" className="bg-white border-b border-slate-200 text-[#11233f] px-6 py-20 lg:px-10 dark:bg-[#0c1626] dark:border-t dark:border-white/10 dark:text-white">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[#e5f7f2] text-[#0d8d78] dark:bg-[#72d6bf]/15 dark:border dark:border-[#72d6bf]/30 px-3.5 py-1 text-xs font-extrabold uppercase tracking-wider dark:text-[#72d6bf]">
              ...
              <p className="mt-2 text-xs sm:text-sm text-slate-500 dark:text-slate-300 max-w-2xl leading-relaxed">
            ...
            <Link
              href="/courses"
              className="inline-flex items-center gap-1 text-sm font-bold text-[#0d8d78] dark:text-[#72d6bf] transition hover:text-[#0b7866] dark:hover:text-[#5ec4ad] hover:underline shrink-0"
            >
          ...
          {coursesLoading ? (
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">{[1, 2, 3].map((item) => <div key={item} className="h-96 animate-pulse rounded-3xl bg-slate-200 dark:bg-white/10" />)}</div>
          ) : courses.length === 0 ? (
            <div className="mt-10 rounded-3xl border border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-white/[.04] p-12 text-center">
              <h3 className="text-lg font-bold text-[#11233f] dark:text-white">Nouveaux cours et packs en cours de publication.</h3>
              <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                Nos professeurs préparent de nouveaux contenus de révision. Revenez bientôt !
              </p>
              <Link
                href="/courses"
                className="mt-5 inline-block rounded-full bg-[#0d8d78] dark:bg-[#72d6bf] px-6 py-3 text-xs font-bold text-white dark:text-[#11233f] transition hover:bg-[#0b7866] dark:hover:bg-[#5ec4ad]"
              >
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {courses
                ...
                .map((course) => (
                  <div
                    key={course.id}
                    className="group flex flex-col justify-between rounded-3xl border border-slate-200 bg-white text-[#11233f] shadow-sm hover:shadow-xl hover:border-[#72d6bf] dark:border-white/15 dark:bg-[#101b2d] dark:text-white dark:shadow-xl transition-all duration-300 hover:-translate-y-1.5 dark:hover:shadow-2xl dark:hover:border-[#72d6bf]/60 overflow-hidden"
                  >
                    <div>
                      ...
                      <div className="relative h-48 w-full overflow-hidden bg-slate-100 dark:bg-slate-900 border-b border-slate-100 dark:border-white/10">
                        ...
                        <div className="absolute bottom-3 right-3 rounded-xl bg-white/95 dark:bg-[#11233f]/95 backdrop-blur-md border border-slate-200 dark:border-[#72d6bf]/40 px-3 py-1 text-xs font-black text-[#0d8d78] dark:text-[#72d6bf] shadow-md">
                      ...
                      <div className="p-6 space-y-3">
                        <span className="text-[11px] font-semibold text-slate-500 dark:text-[#72d6bf] block">
                          {course.level}
                        </span>

                        <h3 className="text-base font-bold text-[#11233f] group-hover:text-[#0d8d78] dark:text-white dark:group-hover:text-[#72d6bf] transition duration-200 line-clamp-2 leading-snug">
                          {course.title}
                        </h3>

                        <p className="text-xs text-slate-500 dark:text-slate-300 leading-relaxed line-clamp-2">
                          {course.description}
                        </p>

                        {/* Teacher and Metrics */}
                        <div className="pt-3 flex items-center justify-between border-t border-slate-100 dark:border-white/10 text-xs text-slate-600 dark:text-slate-300">
                          <div className="flex items-center gap-2">
                            <div className="h-7 w-7 rounded-full bg-[#e5f7f2] text-[#0d8d78] dark:bg-[#72d6bf]/20 dark:text-[#72d6bf] font-bold flex items-center justify-center text-xs dark:border dark:border-[#72d6bf]/30">
      ...
      <section className="bg-slate-50 border-b border-slate-200 text-[#11233f] px-6 py-16 lg:px-10 dark:bg-[#0f1d32] dark:border-white/10 dark:text-white">
        <div className="mx-auto max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="mt-2 font-[family-name:var(--font-dm-sans)] text-2xl sm:text-3xl font-bold tracking-tight text-[#11233f] dark:text-white">
      ...
      <section id="how" className="mx-auto max-w-7xl px-6 py-20 lg:px-10 text-[#11233f] dark:text-white border-t border-slate-200 dark:border-white/10">
        <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm text-[#11233f] dark:border-white/10 dark:bg-white/[.05] dark:text-white dark:shadow-xl dark:backdrop-blur-md">
              <span className="font-[family-name:var(--font-dm-sans)] text-4xl font-bold text-[#0d8d78] dark:text-[#72d6bf]">01</span>
              <h3 className="mt-4 font-bold text-lg text-[#11233f] dark:text-white">Choisissez la matière</h3>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm text-[#11233f] dark:border-white/10 dark:bg-white/[.05] dark:text-white dark:shadow-xl dark:backdrop-blur-md">
              <span className="font-[family-name:var(--font-dm-sans)] text-4xl font-bold text-[#0d8d78] dark:text-[#72d6bf]">02</span>
              <h3 className="mt-4 font-bold text-lg text-[#11233f] dark:text-white">Sélectionnez le créneau</h3>
              <p className="mt-2 text-xs leading-relaxed text-slate-500 dark:text-slate-300">
                Consultez le planning du professeur et réservez l'horaire idéal pour vous.
              </p>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm text-[#11233f] dark:border-white/10 dark:bg-white/[.05] dark:text-white dark:shadow-xl dark:backdrop-blur-md">
              <span className="font-[family-name:var(--font-dm-sans)] text-4xl font-bold text-[#0d8d78] dark:text-[#72d6bf]">03</span>
              <h3 className="mt-4 font-bold text-lg text-[#11233f] dark:text-white">Rejoignez la classe</h3>
              <p className="mt-2 text-xs leading-relaxed text-slate-500 dark:text-slate-300">
      ...
      <section className="bg-slate-50 border-y border-slate-200 text-[#11233f] px-6 py-20 lg:px-10 dark:bg-[#0f1d32] dark:border-white/10 dark:text-white">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              <p className="text-xs font-bold uppercase tracking-[.2em] text-[#0d8d78] dark:text-[#72d6bf]">Avis & Réussite</p>
              <h2 className="mt-2 font-[family-name:var(--font-dm-sans)] text-3xl sm:text-4xl font-bold tracking-tight text-[#11233f] dark:text-white">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-[#0d8d78] dark:bg-[#72d6bf] px-5 py-3 text-xs sm:text-sm font-bold text-white dark:text-[#11233f] shadow-md transition hover:bg-[#0b7866] dark:hover:bg-[#5ec4ad] active:scale-95 shrink-0"
            >
              <IconStar className="h-4 w-4 fill-white dark:fill-[#11233f]" />
              <span>Laisser un avis d'élève satisfait</span>
            </button>
          </div>

          {reviews.length === 0 ? (
            <div className="rounded-3xl border border-slate-200 bg-white dark:border-white/10 dark:bg-white/[.05] p-12 text-center shadow-sm dark:shadow-xl">
              <h3 className="font-bold text-base text-[#11233f] dark:text-white">Aucun avis pour le moment.</h3>
              <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">Soyez le premier élève à partager votre expérience de cours !</p>
              <button
                type="button"
                onClick={() => setReviewModalOpen(true)}
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {reviews.map((r) => (
                <div key={r.id} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm text-[#11233f] dark:border-white/10 dark:bg-white/[.05] dark:text-white dark:shadow-xl dark:backdrop-blur-md flex flex-col justify-between">
                  <div>
                  ...
                  <div className="mt-6 border-t border-slate-100 dark:border-white/10 pt-3 flex items-center justify-between">
                    <div>
                      <p className="font-bold text-sm text-[#11233f] dark:text-white">{r.name}</p>
                      <p className="text-[11px] text-[#0d8d78] dark:text-[#72d6bf] font-semibold">{r.role}</p>
                    </div>
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="rounded-2xl border border-slate-200 bg-white text-[#11233f] shadow-xs dark:border-white/10 dark:bg-white/[.05] dark:text-white dark:backdrop-blur-md overflow-hidden transition dark:shadow-xl"
              >
                <button
                  type="button"
                  onClick={() => setOpenFaq(isOpen ? null : index)}
                  className="flex w-full items-center justify-between p-5 text-left font-bold text-sm text-[#11233f] hover:text-[#0d8d78] dark:text-white dark:hover:text-[#72d6bf] transition"
                >
                  <span>{faq.q}</span>
                  <span className="text-[#0d8d78] dark:text-[#72d6bf] text-base font-bold">{isOpen ? "−" : "+"}</span>
                </button>
                {isOpen && (
                  <div className="px-5 pb-5 pt-1 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-slate-50 dark:border-white/10">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      {/* Footer */}
      <footer className="bg-[#11233f] dark:bg-[#070c14] text-slate-400 px-6 py-10 lg:px-10 border-t border-white/10">
